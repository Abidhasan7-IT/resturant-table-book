...
<nav class="navbar navbar-default navbar-fixed" style="background: #27ae70;">
    <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">ADD FOOD </a>
                </div>
									...
									<div class="row">
										...
										<div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <i style="font-weight: bold; font-size: 19px;" class="pe-7s-upload"></i>
                                                Select Image<input type="file"  style="display: none;" id="file" name="file" required /></label>
                                            </div>
                                        </div>
										
									</div>
									
                                    <input type="submit" name="submit" style="background: #27ae70; border: 1px solid #27ae70" value="Save Food" class="btn btn-info btn-fill pull-right" />
